...
//#define  PROGREESS_RADIUS 50//圆半径
...
//
//    //2.圆形
//    UIColor *pathColorA = [UIColor whiteColor];
//    [pathColorA set];
//    
//    CGPoint center = CGPointMake(self.bounds.size.width*0.5, self.bounds.size.height*0.5);
//    CGFloat x = center.x - PROGREESS_RADIUS;
//    CGFloat y = center.y - PROGREESS_RADIUS;
//    CGFloat w = PROGREESS_RADIUS*2;
//    CGFloat h = w;
